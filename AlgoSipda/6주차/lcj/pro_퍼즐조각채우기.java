...
class Solution {
    ...
    int compareBlock(List<List<Point>> table, List<List<Point>> board, int answer){
    ...
    void bfs(int x, int y, int[][] board, boolean[][] visited, List<List<Point>> list){
    ...
    boolean isRotate(List<Point> table, List<Point> board){
        //오름차순 정렬
